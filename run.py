...
parser.add_argument('--model', type=str, required=True, default='PRNet',
                    help='model name, options: [PRNet, Informer, Autoformer, ...]')
...
parser.add_argument('--reduction', type=int, default=4, help='reduction ratio for LatentChannelRecalibration')
parser.add_argument('--gate_activation', type=str, default='relu', help='activation for gate_mlp')
...
if args.data == 'm4':
    from exp.exp_m4 import Exp_M4 as Exp
else:
